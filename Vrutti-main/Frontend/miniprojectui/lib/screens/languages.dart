...
class Languages extends StatefulWidget {
  static const String id="languages_screen";
  @override
  _Languages createState() => _Languages();
}

class _Languages extends State<Languages> with SingleTickerProviderStateMixin{
                ...
                onTap: (){
                  ...
                  print(countryCode[index]);
                   Navigator.of(context).push(MaterialPageRoute(
                    builder: (BuildContext ctx) => Speech2Text(countryCode[index])));
                },
